...
public class AddTempsCrono extends javax.swing.JPanel {
     ...
     */
    public AddTempsCrono(Club club) {
        initComponents();
        this.club = club;
    ...
    private void initComponents() {
        ...
        cronometro1 = new Est.Nat.Vista.Cronometro();
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(cronometro1, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void fitxFedKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fitxFedKeyReleased
        ...
        if (f.length() >= 8) {
            ...
            if (nadador != null) {
                ...
                Principal.labelBaix.setText("");
            } else {
                fitxFed.requestFocus();
                fitxFed.selectAll();
                Principal.labelBaix.setText("El nadador no existe!");
            }
        }
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        if(fieldBrasades.getText().isEmpty() && fieldLloc.getText().isEmpty())
            ...
            try {
                ...
                Principal.labelBaix.setText("Guardado satisfactoriamente!");
                Principal.barraProgres.setValue(100);
                this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));

                Thread.sleep(5000);
                Principal.labelBaix.setText("");
                Principal.barraProgres.setValue(0);
            } catch (Exception ex) {
...
//            System.out.println("Grafica creada");
    ...
    private Est.Nat.Vista.Cronometro cronometro1;
